...
from isegm.inference.transforms import AddHorizontalFlip, SigmoidForPred, LimitLongestSide, Crops, ZoomIn, ZoomOut
...
class BasePredictor(object):
    ...
    def get_prediction(self, clicker):
        ...
        # TODO: Add transformation that has a largest size of prediction.
        # ZoomIN
